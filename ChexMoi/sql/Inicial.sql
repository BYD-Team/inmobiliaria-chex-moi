...
INSERT INTO `Cliente` VALUE (1, 'Juan', 'Pérez', 'juanperez@gmail.com', SHA2('12345', 256));
INSERT INTO `Cliente` VALUE (2, 'María', 'Gómez', 'mariagomez@gmail.com', SHA2('23456', 256));
INSERT INTO `Cliente` VALUE (3, 'José', 'Hernández', 'josehernandez@gmail.com', SHA2('34567', 256));
INSERT INTO `Cliente` VALUE (4, 'Ana', 'Martínez', 'anamartinez@gmail.com', SHA2('45678', 256));
INSERT INTO `Cliente` VALUE (5, 'Pedro', 'López', 'pedrolopez@gmail.com', SHA2('56789', 256));
INSERT INTO `Cliente` VALUE (6, 'Laura', 'Torres', 'lauratorres@gmail.com', SHA2('67890', 256));
INSERT INTO `Cliente` VALUE (7, 'Carlos', 'Sánchez', 'carlossanchez@gmail.com', SHA2('78901', 256));
INSERT INTO `Cliente` VALUE (8, 'Sofía', 'Ramírez', 'sofiaramirez@gmail.com', SHA2('89012', 256));
INSERT INTO `Cliente` VALUE (9, 'Jorge', 'García', 'jorgegarcia@gmail.com', SHA2('90123', 256));
INSERT INTO `Cliente` VALUE (10, 'Verónica', 'Fernández', 'veronicafernadez@gmail.com', SHA2('01234', 256));
